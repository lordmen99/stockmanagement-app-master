...
Future<OrdersList> getOrdersList({String token}) async {
    final url = "http://stokapp.indofreelancer.id/public/api/orders";
...
Future<String> getUserImage(String token) async {
  final url = "http://stokapp.indofreelancer.id/public/api/profile";
...
Future<String> createOrder({List<Map> body, String token}) async{
  ...
  final url = "http://stokapp.indofreelancer.id/public/api/orders/create";
